          ...
          <div className="col-md-6 offset-md-3">
            ...
            <form onSubmit={e => {handleSubmit(e)}}>
                    ...
                    <div className="from-checkbox-grid">
                      {types.map((e) => (
                        <div className="from-checkbox">
                          ...
                          <input value={e.id} type="checkbox" onChange={e => {handleSelect(e)}} />
                            {e.name}
                            </div>
              ...
              <div className="form-group">
                ...
                <button 
                type="submit" className="form-btn form-btn-primary form-btn-block">
                    Create Pokemon
                </button>
            ...
            <Link to="/home">
              <button 
                ...
                className="form-btn form-btn-secondary form-btn-block">
                    Back to Home
                </button>
            </Link>
            </div>
